            ...
            <div class="bg-white rounded-lg shadow p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5">
                        ...
                        <div class="flex items-center">
                            <span class="text-2xl font-semibold">{{$todaysInterviewsCount}}</span>
            ...
            <div class="bg-white rounded-lg shadow p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5">
                        ...
                        <div class="flex items-center">
                            <span class="text-2xl font-semibold">{{$pendingInterviews}}</span>
            ...
            <div class="bg-white rounded-lg shadow p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5">
                        ...
                        <div class="flex items-center">
                            <span class="text-2xl font-semibold">{{$candidatesThisWeek}}</span>
                            <span class="text-green-500 text-sm ml-2">
                            </span>
                        </div>
                    </div>
