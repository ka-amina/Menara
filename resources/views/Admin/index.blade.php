        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div class="bg-white rounded-lg shadow-md p-6 flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800">{{$candidatesCount}}</p>
                </div>
            </div>
            <div class="bg-white rounded-lg shadow-md p-6 flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800">{{$interviewsCount}}</p>
                </div>
            </div>
            <div class="bg-white rounded-lg shadow-md p-6 flex items-center">
                <div class="rounded-full bg-green-100 p-3 mr-4">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-700">Active Companies</h3>
                    <p class="text-2xl font-bold text-gray-800">{{ $companiesCount }}</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800">{{$interviewersCount}}</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid  gap-8">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="{{ route('evaluations') }}" class="text-indigo-600 hover:text-indigo-800 font-medium text-sm">View All</a>
                </div>
                <div class="overflow-y-auto max-h-80">
                        ...
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-gray-600 text-sm">
                                    Scheduled: {{ $interview->scheduled_at->format('F j, Y \a\t H:i') }}
                                </p>
                                <p class="text-gray-600 text-sm">
                    ...
                    @empty
                    <p class="text-gray-500">No recent interviews found.</p>
                    @endforelse
                </div>
            </div>
