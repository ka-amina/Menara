            ...
            <div class="bg-white rounded-lg p-6 max-w-sm w-full">
                ...
                <form action="#">
                    <div class="mb-4">
                        ...
                        <input type="text" name="hardskill_name" id="hardskill_name" class="mt-1 block w-full border p-2 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                ...
                <table class="min-w-full leading-normal">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <a href="{{route('edithardskill')}}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                        ...
                        <tr>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <div class="flex items-center">
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900">Laravel</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
